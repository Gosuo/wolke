...
impl From<nom::Err<nom::error::Error<&[u8]>>> for Error {
    fn from(value: nom::Err<nom::error::Error<&[u8]>>) -> Self {
        match value {
            nom::Err::Failure(e) => Self::NomError {
                error: std::str::from_utf8(e.input)
                    .unwrap_or("Unable to parse error input")
                    .to_string(),
                error_kind: e.code,
            },
            nom::Err::Incomplete(e) => unreachable!(), // This is risky, but in theory this should be unreachable in this context, as we don't use this error for parsing directly
            nom::Err::Error(_) => unreachable!(), // This is risky, but in theory this should be unreachable in this context, as we don't use this error for parsing directly
        }
    }
}
